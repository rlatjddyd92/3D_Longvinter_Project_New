...
class CUIPage_Crafting : public CUIPage
{
protected:
	CUIPage_Crafting(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUIPage_Crafting(const CUIPage_Crafting& Prototype);
	virtual ~CUIPage_Crafting() = default;
...
public:
	static CUIPage_Crafting* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
