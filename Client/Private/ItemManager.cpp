...
HRESULT CItemManager::Setting_ItemInfo()
{
	...
	{ ITEMINDEX::ITEM_AMMO, TEXT("탄환"), TEXT("샷건 및 기관총 탄환"), false,  ITEMTYPE::ITEM_TYPE_AMMO, true, 200.f, 100, 100.f, 1.f, 0.f};
	...
	if (FAILED(__super::Add_Component(_int(LEVELID::LEVEL_STATIC), TEXT("Prototype_Component_Texture_T_IconShotgun"),
	...
	{ ITEMINDEX::ITEM_ARROW, TEXT("화살"), TEXT("조용히 적을 처치할 때 사용합니다."), false,  ITEMTYPE::ITEM_TYPE_AMMO, true, 250.f, 5100, 100.f, 1.f, 15.f };
	...
	{ ITEMINDEX::ITEM_CHAINSAW, TEXT("전기톱"), TEXT("나무를 벨 때 사용하며, 적에게도 사용할 수 있습니다."), true,  ITEMTYPE::ITEM_TYPE_WEAPON, false, 20.f, 3100, 1400.f, 1.f, 9.f };
	...
	{ ITEMINDEX::ITEM_COAL_INGOT, TEXT("정제된 석탄"), TEXT("높은 화력을 얻을 수 있습니다."), false,  ITEMTYPE::ITEM_TYPE_MINERAL, true, 10.f, 900, 11200.f, 231.f, 44.f };
	...
	{ ITEMINDEX::ITEM_COAL_ORE_CHUNK, TEXT("석탄 덩어리"), TEXT("화력이 낮습니다. 정제하면 더 높은 화력을 얻을 수 있습니다."), false,  ITEMTYPE::ITEM_TYPE_MINERAL, true, 150.f, 78100, 340.f, 23.f , 23.f};
	...
	{ ITEMINDEX::ITEM_COPPER_INGOT, TEXT("구리 주괴"), TEXT("각종 도구 제작에 사용합니다."), false,  ITEMTYPE::ITEM_TYPE_MINERAL, true, 800.f, 16500,4400.f, 45.f, 52.f };
	...
	{ ITEMINDEX::ITEM_COPPER_ORE_CHUNK, TEXT("구리 덩어리"), TEXT("제작에 사용하려면 정제해야 합니다."), false,  ITEMTYPE::ITEM_TYPE_MINERAL, true, 10.f, 13400, 50.f, 23.f, 58.f };
	...
	m_vecItemInfo[_int(ITEMINDEX::ITEM_MACHINEGUN)] =
	{ ITEMINDEX::ITEM_MACHINEGUN, TEXT("기관총"), TEXT("막대한 화력을 자랑합니다."), true,  ITEMTYPE::ITEM_TYPE_WEAPON, false, 2000.f, 2000, 1000.f,0.f , 0.f };
	if (FAILED(__super::Add_Component(_int(LEVELID::LEVEL_STATIC), TEXT("Prototype_Component_Texture_T_IconMachineGun"),
		TEXT("Com_Texture_10"), reinterpret_cast<CComponent**>(&m_vecItemInvenTexture[_int(ITEMINDEX::ITEM_MACHINEGUN)]))))
		return E_FAIL;
	m_vecItemTag[_int(ITEMINDEX::ITEM_MACHINEGUN)].resize(_int(ITEMTAG::ITEM_TAG_END));
	m_vecItemTag[_int(ITEMINDEX::ITEM_MACHINEGUN)][_int(ITEMTAG::ITEM_TAG_HEAVYDEMAGE)] = true;
	m_vecItemTag[_int(ITEMINDEX::ITEM_MACHINEGUN)][_int(ITEMTAG::ITEM_TAG_HIGHPRICE)] = true;

	m_pGameInstance->Add_CloneObject_ToLayer(_uint(LEVELID::LEVEL_STATIC), TEXT("Layer_Tool_MachineGun"), TEXT("Prototype_GameObject_Tool_MachineGun"), &ToolDesc);
	m_vecTool[_int(ITEMINDEX::ITEM_MACHINEGUN)] = static_cast<CTool*>(m_pGameInstance->Get_CloneObject_ByLayer(_uint(LEVELID::LEVEL_STATIC), TEXT("Layer_Tool_MachineGun"), -1));



	m_vecItemInfo[_int(ITEMINDEX::ITEM_FISH)] =
	{ ITEMINDEX::ITEM_FISH, TEXT("물고기"), TEXT("상할 수 있으니 빠르게 조리하거나 섭취하세요"), false,  ITEMTYPE::ITEM_TYPE_FOOD, true, 200.f, 7800, 4500.f, 33.f, 890.f };
	...
	{ ITEMINDEX::ITEM_IRON_INGOT, TEXT("철 주괴"), TEXT("각종 도구 제작에 사용합니다."), false,  ITEMTYPE::ITEM_TYPE_MINERAL, true, 220.f, 2300, 340.f, 37.f, 34.f };
	...
	{ ITEMINDEX::ITEM_IRON_ORE_CHUNK, TEXT("철 덩어리"), TEXT("제작에 사용하려면 정제해야 합니다."), false,  ITEMTYPE::ITEM_TYPE_MINERAL, true, 500.f, 1760, 330.f, 34.f , 87.f};
	...
	{ ITEMINDEX::ITEM_GOLD_INGOT, TEXT("금 주괴"), TEXT("비싼 가격에 팔거나 특수 아이템 제작에 사용합니다."), false,  ITEMTYPE::ITEM_TYPE_MINERAL, true, 900.f, 4500, 4560.f, 56.f, 4311.f };
	...
	{ ITEMINDEX::ITEM_GOLD_ORE_CHUNK, TEXT("금 덩어리"), TEXT("비싸게 팔 수 있지만 제작에 사용하려면 정제해야 합니다."), false,  ITEMTYPE::ITEM_TYPE_MINERAL, true, 120.f, 3400, 340.f, 33.f, 87.f };
	...
	{ ITEMINDEX::ITEM_JAM, TEXT("잼"), TEXT("빵과 잘 어울리며 좋은 가격에 팔 수도 있습니다."), false,  ITEMTYPE::ITEM_TYPE_FOOD, true, 9400.f, 2300, 330.f, 54.f, 38.f };
	...
	{ ITEMINDEX::ITEM_MEAT, TEXT("날고기"), TEXT("상할 수 있으니 빠르게 조리하거나 섭취하세요"), false,  ITEMTYPE::ITEM_TYPE_FOOD, true, 1550.f, 4100, 350.f,53.f , 55.f};
	...
	m_vecItemInfo[_int(ITEMINDEX::ITEM_GRANADE)] =
	{ ITEMINDEX::ITEM_GRANADE, TEXT("수류탄"), TEXT("폭발 시, 많은 파편을 발생시킵니다."), true,  ITEMTYPE::ITEM_TYPE_WEAPON, true, 2000.f, 2000, 1000.f,0.f , 0.f };
	if (FAILED(__super::Add_Component(_int(LEVELID::LEVEL_STATIC), TEXT("Prototype_Component_Texture_T_IconGrenade"),
		TEXT("Com_Texture_20"), reinterpret_cast<CComponent**>(&m_vecItemInvenTexture[_int(ITEMINDEX::ITEM_GRANADE)]))))
		return E_FAIL;
	m_vecItemTag[_int(ITEMINDEX::ITEM_GRANADE)].resize(_int(ITEMTAG::ITEM_TAG_END));
	m_vecItemTag[_int(ITEMINDEX::ITEM_GRANADE)][_int(ITEMTAG::ITEM_TAG_HEAVYDEMAGE)] = true;

	m_pGameInstance->Add_CloneObject_ToLayer(_uint(LEVELID::LEVEL_STATIC), TEXT("Layer_Tool_Granade"), TEXT("Prototype_GameObject_Tool_Granade"), &ToolDesc);
	m_vecTool[_int(ITEMINDEX::ITEM_GRANADE)] = static_cast<CTool*>(m_pGameInstance->Get_CloneObject_ByLayer(_uint(LEVELID::LEVEL_STATIC), TEXT("Layer_Tool_Granade"), -1));


	m_vecItemInfo[_int(ITEMINDEX::ITEM_FIRETHROWER)] =
	{ ITEMINDEX::ITEM_FIRETHROWER, TEXT("화염방사기"), TEXT("주변에 불을 붙입니다."), true,  ITEMTYPE::ITEM_TYPE_WEAPON, false, 1200.f, 12000, 1500.f,0.f , 0.f };
	if (FAILED(__super::Add_Component(_int(LEVELID::LEVEL_STATIC), TEXT("Prototype_Component_Texture_T_IconFireThrower"),
		TEXT("Com_Texture_21"), reinterpret_cast<CComponent**>(&m_vecItemInvenTexture[_int(ITEMINDEX::ITEM_FIRETHROWER)]))))
		return E_FAIL;
	m_vecItemTag[_int(ITEMINDEX::ITEM_FIRETHROWER)].resize(_int(ITEMTAG::ITEM_TAG_END));
	m_vecItemTag[_int(ITEMINDEX::ITEM_FIRETHROWER)][_int(ITEMTAG::ITEM_TAG_HEAVYDEMAGE)] = true;
	m_vecItemTag[_int(ITEMINDEX::ITEM_FIRETHROWER)][_int(ITEMTAG::ITEM_TAG_BURN)] = true;

	m_pGameInstance->Add_CloneObject_ToLayer(_uint(LEVELID::LEVEL_STATIC), TEXT("Layer_Tool_FireThrower"), TEXT("Prototype_GameObject_Tool_FireThrower"), &ToolDesc);
	m_vecTool[_int(ITEMINDEX::ITEM_FIRETHROWER)] = static_cast<CTool*>(m_pGameInstance->Get_CloneObject_ByLayer(_uint(LEVELID::LEVEL_STATIC), TEXT("Layer_Tool_FireThrower"), -1));



	m_vecItemInfo[_int(ITEMINDEX::ITEM_LANDMINE)] =
	{ ITEMINDEX::ITEM_LANDMINE, TEXT("지뢰"), TEXT("좌클릭: 적 감지형 지뢰, 우클릭: 시한폭탄"), true,  ITEMTYPE::ITEM_TYPE_WEAPON, false, 5000.f, 100, 10000.f,0.f , 0.f };
	if (FAILED(__super::Add_Component(_int(LEVELID::LEVEL_STATIC), TEXT("Prototype_Component_Texture_T_IconMine"),
		TEXT("Com_Texture_22"), reinterpret_cast<CComponent**>(&m_vecItemInvenTexture[_int(ITEMINDEX::ITEM_LANDMINE)]))))
		return E_FAIL;
	m_vecItemTag[_int(ITEMINDEX::ITEM_LANDMINE)].resize(_int(ITEMTAG::ITEM_TAG_END));
	m_vecItemTag[_int(ITEMINDEX::ITEM_LANDMINE)][_int(ITEMTAG::ITEM_TAG_HEAVYDEMAGE)] = true;
	m_vecItemTag[_int(ITEMINDEX::ITEM_LANDMINE)][_int(ITEMTAG::ITEM_TAG_HIGHPRICE)] = true;

	m_pGameInstance->Add_CloneObject_ToLayer(_uint(LEVELID::LEVEL_STATIC), TEXT("Layer_Tool_LandMine"), TEXT("Prototype_GameObject_Tool_LandMine"), &ToolDesc);
	m_vecTool[_int(ITEMINDEX::ITEM_LANDMINE)] = static_cast<CTool*>(m_pGameInstance->Get_CloneObject_ByLayer(_uint(LEVELID::LEVEL_STATIC), TEXT("Layer_Tool_LandMine"), -1));


	m_vecItemInfo[_int(ITEMINDEX::ITEM_BOW)] =
	{ ITEMINDEX::ITEM_BOW, TEXT("석궁"), TEXT("적을 조용히 처리합니다."), true,  ITEMTYPE::ITEM_TYPE_WEAPON, false, 1000.f, 22000, 500.f,10.f , 0.f };
	if (FAILED(__super::Add_Component(_int(LEVELID::LEVEL_STATIC), TEXT("Prototype_Component_Texture_T_IconCrossbow"),
		TEXT("Com_Texture_23"), reinterpret_cast<CComponent**>(&m_vecItemInvenTexture[_int(ITEMINDEX::ITEM_BOW)]))))
		return E_FAIL;
	m_vecItemTag[_int(ITEMINDEX::ITEM_BOW)].resize(_int(ITEMTAG::ITEM_TAG_END));
	m_vecItemTag[_int(ITEMINDEX::ITEM_BOW)][_int(ITEMTAG::ITEM_TAG_QUIET)] = true;
	m_vecItemTag[_int(ITEMINDEX::ITEM_BOW)][_int(ITEMTAG::ITEM_TAG_HIGHPRICE)] = true;
