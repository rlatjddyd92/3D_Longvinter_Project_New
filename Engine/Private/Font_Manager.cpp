...
HRESULT CFont_Manager::Render(const _wstring& strFontTag, const _tchar* pText, _fvector vPosition, _float fScale, _bool bCenterDraw, _fvector vColor, _float fRadian, _fvector vPivot)
{
